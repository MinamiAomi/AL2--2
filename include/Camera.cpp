...
void Camera::DrawAxis()
{
	...
	Novice::DrawLine(0, static_cast<int>(scrWorldOrgin.y), m_windowSize.x, static_cast<int>(scrWorldOrgin.y), RED);
	Novice::DrawLine(static_cast<int>(scrWorldOrgin.x), 0, static_cast<int>(scrWorldOrgin.x), m_windowSize.y, BLUE);
}
